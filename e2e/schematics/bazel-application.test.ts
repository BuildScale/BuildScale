...
// import { BuildScaleModule } from '@buildscale/buildscale';

// @NgModule({
// imports: [BrowserModule, MyLibModule, StoreModule.forRoot({}),
// BuildScaleModule.forRoot()], declarations: [AppComponent], bootstrap: [AppComponent]
// })
...
//   require('@buildscale/schematics/src/utils/cli-config-utils'); const appDir =
